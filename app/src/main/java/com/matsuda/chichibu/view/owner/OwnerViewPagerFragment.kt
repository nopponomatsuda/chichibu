...
class OwnerViewPagerFragment : Fragment() {

    companion object {
        fun newInstance(areaId: String): OwnerViewPagerFragment {
            return OwnerViewPagerFragment().apply {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            viewPager.run {
                adapter = OwnerTabAdapter(context, childFragmentManager, areaId)
